subroutine Solvefirstactive(counter)
                ...
                do iuf = 1, nu
                    ...
                    do
                        ...
                        if(dum2<0.0001d0) then
                            ...
                            vnext = trilin_interp(k_grid,exp_grid(:,T+1-it),exp_grid(:,T+1-it), &
                                            ev(:,:,:,iam,ium,iaf,iuf,T+1-it,ifc,ifcm), &
                                            nk, nexp, nexp, pnt2)
                            !vnext = D_QD3VL(dum2,exp_grid(ix,T-it)+1d0,exp_grid(ixm,T-it)+1d0,k_grid,exp_grid(:,T+1-it),exp_grid(:,T+1-it),ev(:,:,:,iam,ium,iaf,iuf,T+1-it,ifc,ifcm))
                    ...
                    do
                        ...
                        if(dum2<0.0001d0) then
                            ...
                            vnext = trilin_interp(k_grid,exp_grid(:,T+1-it),exp_grid(:,T+1-it), &
                                            ev(:,:,:,iam,ium,iaf,iuf,T+1-it,ifc,ifcm), &
                                            nk, nexp, nexp, pnt2)
                            !vnext = D_QD3VL(dum2,exp_grid(ix,T-it)*(1d0-deltaexp),exp_grid(ixm,T-it)+1d0,k_grid,exp_grid(:,T+1-it),exp_grid(:,T+1-it),ev(:,:,:,iam,ium,iaf,iuf,T+1-it,ifc,ifcm))
                            V2=V2+beta*OmegaActive(T-it)*vnext
                        end if
                    ...
                    do
                        ...
                        if(dum2<0.0001d0) then
                            ...
                            vnext = trilin_interp(k_grid,exp_grid(:,T+1-it),exp_grid(:,T+1-it), &
                                            ev(:,:,:,iam,ium,iaf,iuf,T+1-it,ifc,ifcm), &
                                            nk, nexp, nexp, pnt2)
                            !vnext = D_QD3VL(dum2,exp_grid(ix,T-it)+1d0,exp_grid(ixm,T-it)*(1d0-deltaexp),k_grid,exp_grid(:,T+1-it),exp_grid(:,T+1-it),ev(:,:,:,iam,ium,iaf,iuf,T+1-it,ifc,ifcm))
                            V2=V2+beta*OmegaActive(T-it)*vnext
                        end if
                    ...
                    do
                        ...
                        if(dum2<0.0001d0) then
                            ...
                            vnext = trilin_interp(k_grid,exp_grid(:,T+1-it),exp_grid(:,T+1-it), &
                                            ev(:,:,:,iam,ium,iaf,iuf,T+1-it,ifc,ifcm), &
                                            nk, nexp, nexp, pnt2)
                            !vnext = D_QD3VL(dum2,exp_grid(ix,T-it)*(1d0-deltaexp),exp_grid(ixm,T-it)*(1d0-deltaexp),k_grid,exp_grid(:,T+1-it),exp_grid(:,T+1-it),ev(:,:,:,iam,ium,iaf,iuf,T+1-it,ifc,ifcm))
                            V2=V2+beta*OmegaActive(T-it)*vnext
                        end if
